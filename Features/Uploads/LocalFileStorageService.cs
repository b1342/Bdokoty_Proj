...
public sealed class LocalFileStorageService : IFileStorageService
{
    ...
    public async Task<UploadWorkMediaResponse> SaveWorkMediaAsync(IFormFile file, CancellationToken cancellationToken = default)
    {
        if (file is null)
        {
        ...
        return new UploadWorkMediaResponse
        {
